...
class Encoder(nn.Module):
    ...
    def forward(self, ids, attention_mask,ge):
        ...
        embdding = torch.cat((embedding,ge),dim=1)
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, source_ids=None, source_mask=None, target_ids=None, target_mask=None, args=None,ge=None):
        # batchxlengh
        outputs = self.encoder(source_ids, attention_mask=source_mask,ge=ge)
